...
class MainGenre(TimeStampedModel):
    ...
    image = models.ImageField("Image", upload_to="media/main_genre/", blank=True)
...
class SubGenre(TimeStampedModel):
    ...
    image = models.ImageField("Image", upload_to="media/subgenre/", blank=True)
...
class Game(TimeStampedModel):
    ...
    image = models.ImageField("Image", upload_to='media/game/', blank=True)
